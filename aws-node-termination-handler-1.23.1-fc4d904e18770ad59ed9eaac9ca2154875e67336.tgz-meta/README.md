[![CircleCI](https://circleci.com/gh/giantswarm/aws-node-termination-handler-app.svg?style=shield)](https://circleci.com/gh/giantswarm/aws-node-termination-handler-app)

# aws-node-termination-handler chart

Giant Swarm offers an `aws-node-termination-handler-bundle` Managed App which can be installed in tenant clusters.
Here we define the `aws-node-termination-handler-bundle` and `aws-node-termination-handler` charts with their templates and default configuration.
...
+-----------------------------------------+ +-------------------------------------------+
| aws-node-termination-handler-bundle     | | aws-node-termination-handler              |
|                                         | |                                           |
...
|-------|----------|-------------|---------|
| `aws-node-termination-handler-bundle` | `helm/aws-node-termination-handler-bundle/` | Management cluster | Orchestrator: IAM role (Crossplane), Flux resources, computed values ConfigMap |
...
kind: App
metadata:
  name: aws-node-termination-handler-bundle
  namespace: org-<org>
spec:
  catalog: giantswarm
  name: aws-node-termination-handler-bundle
...
helm lint helm/aws-node-termination-handler-bundle/
